      ...
      <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-6">
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <div key={index} className={`glass-light geo-chamfer p-6 hover-lift`}>
                ...
                <div className="glass-light geo-chamfer p-6 hover-lift">
        ...
        <section className="px-6 pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="bg-surface border border-border geo-chamfer-lg p-8 text-center hover-lift">
