  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-deep">
        <div className="w-full max-w-md bg-surface rounded-xl shadow-ambient border border-success/30 p-8 text-center">
          ...
          <Link
            to="/"
            className="block w-full py-3 bg-gradient-to-r from-primary via-gold to-coral hover:from-primary-hover hover:via-gold/90 hover:to-coral/90 text-white rounded-lg font-heading font-medium transition-all duration-300 shadow-lg"
          >
            Back to Home
          </Link>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-6">
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <div key={index} className={`bg-surface border ${color.border} rounded-xl p-6`}>
                ...
                <div className="bg-surface border border-border rounded-xl p-6">
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="w-10 h-10 bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg flex items-center justify-center hover:from-primary/40 hover:to-primary/20 transition-all border border-primary/30">
                      <Icon name="globe" className="w-5 h-5 text-text-primary" />
                    </a>
                    <a href="#" className="w-10 h-10 bg-gradient-to-br from-gold/20 to-gold/5 rounded-lg flex items-center justify-center hover:from-gold/40 hover:to-gold/20 transition-all border border-gold/30">
                      <Icon name="mail" className="w-5 h-5 text-gold" />
                    </a>
                    <a href="#" className="w-10 h-10 bg-gradient-to-br from-coral/20 to-coral/5 rounded-lg flex items-center justify-center hover:from-coral/40 hover:to-coral/20 transition-all border border-coral/30">
        ...
        <section className="px-6 pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="bg-surface border border-border rounded-xl p-8 text-center">
              ...
              <Link 
                to="/faq"
                className="inline-block px-6 py-2 bg-transparent border border-border hover:border-primary text-text-primary rounded-lg font-medium transition-colors"
              >
                View FAQ
              </Link>
            </div>
